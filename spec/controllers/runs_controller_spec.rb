...
RSpec.describe RunsController, type: :controller do
  ...
  let(:valid_attributes) { FactoryGirl.build(:run) }
  #let(:invalid_attributes) { FactoryGirl.build(:invalidrun) }
  ...
  describe "POST #create" do
    ...
    context "with invalid params" do
      it "assigns a newly created but unsaved run as @run" do
        post :create, params: {run: build_attributes(:invalidrun)}, session: valid_session
        expect(assigns(:run)).to be_a_new(Run)
      end
  ...
  describe "PUT #update" do
    context "with valid params" do
      ...
      it "assigns the requested run as @run" do
        #run = Run.create! valid_attributes
        put :update, params: {id: run.to_param, run: build_attributes(:run)}, session: valid_session
        expect(assigns(:run)).to eq(run)
      end
    ...
    context "with invalid params" do
      it "assigns the run as @run" do
        #run = Run.create! valid_attributes
        put :update, params: {id: run.to_param, run: FactoryGirl.attributes_for(:invalidrun)}, session: valid_session
        expect(assigns(:run)).to eq(run)
      end
